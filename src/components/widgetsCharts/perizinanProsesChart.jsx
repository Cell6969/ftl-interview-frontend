...
import { PerizinanChartOptions } from "@/utils/chartsLogic/perizinanChartOptions";

const PerizinanChart = ({ title, data }) => {
  const {
    refreshKey,
    isRemoved,
    isExpanded,
  ...
  const chartOptions = PerizinanChartOptions(data);
